  ...
  return function(config) {
    ...
    if (config.almond === true) {
        ...
        if (config.removeCombined === true) {
          var temporaryAlmond = temp.openSync('almond');
          fs.writeFileSync(temporaryAlmond.path, fs.readFileSync(configClone.paths.almond + '.js'));
          configClone.paths.almond = temporaryAlmond.path;
        }
        ...
        moduleIterator.forEach(function(module, idx) {
          ...
          if (util._.isArray(module.include) === true) {
